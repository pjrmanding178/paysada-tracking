...
#closeButton {
    z-index: 1100; 
        ...
        .legend-list {
            ...
            gap: 8px;
            margin-bottom: 20px; /* Custom margin at the bottom */
        }
...
<body class="bg-white font-sans">
    ...
    <div class="pt-6 flex gap-10">
        <div class="mx-40">
            ...
            <!-- Fare Collected List -->
            <h3 class="text-lg font-semibold">Fare Collected:</h3>
            <ul class="mt-4">
                <li>Jan 1 - 10 (Week 1): 1,005 PHP</li>
                <li>Jan 11 - 20 (Week 2): 1,005 PHP</li>
                <li>Jan 21 - 30 (Week 3): 1,005 PHP</li>
                <li>Jan 31 - Feb 7 (Week 4): 800 PHP</li>
            </ul>

            <!-- Total Fare -->
            <h3 class="text-lg font-bold mt-4">Total: 3,815 PHP</h3>
        </div>
...
function toggleSidebar() {
    ...
    <script>
        ...
        const data = {
            ...
            datasets: [{
                label: 'Transactions',
                data: [1005, 1005, 1005, 800],  // Data for each week
